          ...
          <form action="https://getform.io/f/jawxjmrb" method='POST' className='grid gap-4'>
            <div className='grid gap-4 sm:grid-cols-2'>
              <input
                ...
                className='rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-slate-100 placeholder:text-slate-400 outline-none transition focus:border-cyan-300/60 focus:bg-white/10'
              />
              <input
                type="email"
                name='email'
            ...
            <button className='inline-flex w-fit items-center justify-center rounded-full bg-gradient-to-r from-cyan-400 via-sky-400 to-indigo-500 px-6 py-3 font-semibold text-slate-950 transition hover:scale-[1.02]'>
              Submit
            </button>
          </form>
        </div>
