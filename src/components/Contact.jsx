...
const Contact = () => {
  return (
    <div name='contact' className='max-width-screen-lg w-full h-full'>
      ...
      <p className='text-[19px] text-[#404163] font-semibold sm:text-[24px]'>Lets get in touch!</p>
      </div>

      <div className='flex w-[90%] h-full items-center justify-center p-4 mx-auto sm:w-[80%]'>
        <form action="https://getform.io/f/jawxjmrb" method='POST' className='flex flex-col'>
          <input type="text"
          name='name'
          placeholder='Enter your name'
          className='p-2 my-2 bg-gray-100 border-1 rounded-md text-[#0c0e3e] focus:outline-none'/>
